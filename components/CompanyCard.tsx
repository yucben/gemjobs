...
export default function CompanyCard({ company }: { company: Company }) {
  return (
    <Link
      ...
      className="block p-5 rounded-xl bg-white border border-gray-100 hover:border-primary/30 hover:shadow-lg hover:shadow-primary/5 transition-all duration-200 group"
    >
      ...
      <p className="text-sm text-text-muted line-clamp-2 mb-3">{company.description}</p>
